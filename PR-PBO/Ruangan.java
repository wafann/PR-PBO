...
public class Ruangan {
    ...
    private ItemGaBisaDiambil objPintu;
    private Npc objNPC;
    private ItemBisaDiambil  objRoti;
    private ArrayList<Objek> arrItem = new ArrayList<>();
...
//        }
    ...
    public void hapusItem(Objek objItem) {
        arrItem.remove(objItem);  //buang item
    }

    public void addItem(Objek objItem) {
        arrItem.add(objItem);
    }
